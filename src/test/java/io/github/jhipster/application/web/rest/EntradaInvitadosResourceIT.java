...
public class EntradaInvitadosResourceIT {
    ...
    @Autowired
    private EntradaInvitadosMapper entradaInvitadosMapper;
    ...
    public void createEntradaInvitados() throws Exception {
        ...
        EntradaInvitadosDTO entradaInvitadosDTO = entradaInvitadosMapper.toDto(entradaInvitados);
        restEntradaInvitadosMockMvc.perform(post("/api/entrada-invitados")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(entradaInvitadosDTO)))
    ...
    public void updateEntradaInvitados() throws Exception {
        ...
        updatedEntradaInvitados
            ...
            .tipoIngreso(UPDATED_TIPO_INGRESO)
            .tiempoMaximo(UPDATED_TIEMPO_MAXIMO);
        EntradaInvitadosDTO entradaInvitadosDTO = entradaInvitadosMapper.toDto(updatedEntradaInvitados);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EntradaInvitadosDTO.class);
        EntradaInvitadosDTO entradaInvitadosDTO1 = new EntradaInvitadosDTO();
        entradaInvitadosDTO1.setId(1L);
        EntradaInvitadosDTO entradaInvitadosDTO2 = new EntradaInvitadosDTO();
        assertThat(entradaInvitadosDTO1).isNotEqualTo(entradaInvitadosDTO2);
        entradaInvitadosDTO2.setId(entradaInvitadosDTO1.getId());
        assertThat(entradaInvitadosDTO1).isEqualTo(entradaInvitadosDTO2);
        entradaInvitadosDTO2.setId(2L);
        assertThat(entradaInvitadosDTO1).isNotEqualTo(entradaInvitadosDTO2);
        entradaInvitadosDTO1.setId(null);
        assertThat(entradaInvitadosDTO1).isNotEqualTo(entradaInvitadosDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(entradaInvitadosMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(entradaInvitadosMapper.fromId(null)).isNull();
    }
}
