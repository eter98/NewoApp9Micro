...
public class MiembrosEquipoEmpresasResourceIT {
    ...
    @Autowired
    private MiembrosEquipoEmpresasMapper miembrosEquipoEmpresasMapper;
    ...
    public void createMiembrosEquipoEmpresas() throws Exception {
        ...
        MiembrosEquipoEmpresasDTO miembrosEquipoEmpresasDTO = miembrosEquipoEmpresasMapper.toDto(miembrosEquipoEmpresas);
        restMiembrosEquipoEmpresasMockMvc.perform(post("/api/miembros-equipo-empresas")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(miembrosEquipoEmpresasDTO)))
    ...
    public void updateMiembrosEquipoEmpresas() throws Exception {
        ...
        MiembrosEquipoEmpresasDTO miembrosEquipoEmpresasDTO = miembrosEquipoEmpresasMapper.toDto(updatedMiembrosEquipoEmpresas);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(MiembrosEquipoEmpresasDTO.class);
        MiembrosEquipoEmpresasDTO miembrosEquipoEmpresasDTO1 = new MiembrosEquipoEmpresasDTO();
        miembrosEquipoEmpresasDTO1.setId(1L);
        MiembrosEquipoEmpresasDTO miembrosEquipoEmpresasDTO2 = new MiembrosEquipoEmpresasDTO();
        assertThat(miembrosEquipoEmpresasDTO1).isNotEqualTo(miembrosEquipoEmpresasDTO2);
        miembrosEquipoEmpresasDTO2.setId(miembrosEquipoEmpresasDTO1.getId());
        assertThat(miembrosEquipoEmpresasDTO1).isEqualTo(miembrosEquipoEmpresasDTO2);
        miembrosEquipoEmpresasDTO2.setId(2L);
        assertThat(miembrosEquipoEmpresasDTO1).isNotEqualTo(miembrosEquipoEmpresasDTO2);
        miembrosEquipoEmpresasDTO1.setId(null);
        assertThat(miembrosEquipoEmpresasDTO1).isNotEqualTo(miembrosEquipoEmpresasDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(miembrosEquipoEmpresasMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(miembrosEquipoEmpresasMapper.fromId(null)).isNull();
    }
}
