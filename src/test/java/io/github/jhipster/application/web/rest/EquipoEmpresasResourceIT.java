...
public class EquipoEmpresasResourceIT {
    ...
    @Autowired
    private EquipoEmpresasMapper equipoEmpresasMapper;
    ...
    public void createEquipoEmpresas() throws Exception {
        ...
        EquipoEmpresasDTO equipoEmpresasDTO = equipoEmpresasMapper.toDto(equipoEmpresas);
        restEquipoEmpresasMockMvc.perform(post("/api/equipo-empresas")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(equipoEmpresasDTO)))
    ...
    public void updateEquipoEmpresas() throws Exception {
        ...
        updatedEquipoEmpresas
            ...
            .logosContentType(UPDATED_LOGOS_CONTENT_TYPE)
            .paginaWeb(UPDATED_PAGINA_WEB);
        EquipoEmpresasDTO equipoEmpresasDTO = equipoEmpresasMapper.toDto(updatedEquipoEmpresas);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EquipoEmpresasDTO.class);
        EquipoEmpresasDTO equipoEmpresasDTO1 = new EquipoEmpresasDTO();
        equipoEmpresasDTO1.setId(1L);
        EquipoEmpresasDTO equipoEmpresasDTO2 = new EquipoEmpresasDTO();
        assertThat(equipoEmpresasDTO1).isNotEqualTo(equipoEmpresasDTO2);
        equipoEmpresasDTO2.setId(equipoEmpresasDTO1.getId());
        assertThat(equipoEmpresasDTO1).isEqualTo(equipoEmpresasDTO2);
        equipoEmpresasDTO2.setId(2L);
        assertThat(equipoEmpresasDTO1).isNotEqualTo(equipoEmpresasDTO2);
        equipoEmpresasDTO1.setId(null);
        assertThat(equipoEmpresasDTO1).isNotEqualTo(equipoEmpresasDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(equipoEmpresasMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(equipoEmpresasMapper.fromId(null)).isNull();
    }
}
