...
public class UsoRecursoFisicoResourceIT {
    ...
    @Autowired
    private UsoRecursoFisicoMapper usoRecursoFisicoMapper;
    ...
    public void createUsoRecursoFisico() throws Exception {
        ...
        UsoRecursoFisicoDTO usoRecursoFisicoDTO = usoRecursoFisicoMapper.toDto(usoRecursoFisico);
        restUsoRecursoFisicoMockMvc.perform(post("/api/uso-recurso-fisicos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(usoRecursoFisicoDTO)))
    ...
    public void updateUsoRecursoFisico() throws Exception {
        ...
        updatedUsoRecursoFisico
            ...
            .registroFechaFinal(UPDATED_REGISTRO_FECHA_FINAL)
            .tipoRegistro(UPDATED_TIPO_REGISTRO);
        UsoRecursoFisicoDTO usoRecursoFisicoDTO = usoRecursoFisicoMapper.toDto(updatedUsoRecursoFisico);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(UsoRecursoFisicoDTO.class);
        UsoRecursoFisicoDTO usoRecursoFisicoDTO1 = new UsoRecursoFisicoDTO();
        usoRecursoFisicoDTO1.setId(1L);
        UsoRecursoFisicoDTO usoRecursoFisicoDTO2 = new UsoRecursoFisicoDTO();
        assertThat(usoRecursoFisicoDTO1).isNotEqualTo(usoRecursoFisicoDTO2);
        usoRecursoFisicoDTO2.setId(usoRecursoFisicoDTO1.getId());
        assertThat(usoRecursoFisicoDTO1).isEqualTo(usoRecursoFisicoDTO2);
        usoRecursoFisicoDTO2.setId(2L);
        assertThat(usoRecursoFisicoDTO1).isNotEqualTo(usoRecursoFisicoDTO2);
        usoRecursoFisicoDTO1.setId(null);
        assertThat(usoRecursoFisicoDTO1).isNotEqualTo(usoRecursoFisicoDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(usoRecursoFisicoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(usoRecursoFisicoMapper.fromId(null)).isNull();
    }
}
