...
public class InvitadosResourceIT {
    ...
    public void createInvitados() throws Exception {
        ...
        InvitadosDTO invitadosDTO = invitadosMapper.toDto(invitados);
        restInvitadosMockMvc.perform(post("/api/invitados")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(invitadosDTO)))
    ...
    public void updateInvitados() throws Exception {
        ...
        updatedInvitados
            ...
            .correo(UPDATED_CORREO)
            .telefono(UPDATED_TELEFONO);
        InvitadosDTO invitadosDTO = invitadosMapper.toDto(updatedInvitados);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(InvitadosDTO.class);
        InvitadosDTO invitadosDTO1 = new InvitadosDTO();
        invitadosDTO1.setId(1L);
        InvitadosDTO invitadosDTO2 = new InvitadosDTO();
        assertThat(invitadosDTO1).isNotEqualTo(invitadosDTO2);
        invitadosDTO2.setId(invitadosDTO1.getId());
        assertThat(invitadosDTO1).isEqualTo(invitadosDTO2);
        invitadosDTO2.setId(2L);
        assertThat(invitadosDTO1).isNotEqualTo(invitadosDTO2);
        invitadosDTO1.setId(null);
        assertThat(invitadosDTO1).isNotEqualTo(invitadosDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(invitadosMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(invitadosMapper.fromId(null)).isNull();
    }
}
