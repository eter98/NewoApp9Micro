...
public class EspacioLibreResourceIT {
    ...
    @Autowired
    private EspacioLibreMapper espacioLibreMapper;
    ...
    public void createEspacioLibre() throws Exception {
        ...
        EspacioLibreDTO espacioLibreDTO = espacioLibreMapper.toDto(espacioLibre);
        restEspacioLibreMockMvc.perform(post("/api/espacio-libres")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(espacioLibreDTO)))
    ...
    public void updateEspacioLibre() throws Exception {
        ...
        updatedEspacioLibre
            ...
            .imagen6(UPDATED_IMAGEN_6)
            .imagen6ContentType(UPDATED_IMAGEN_6_CONTENT_TYPE);
        EspacioLibreDTO espacioLibreDTO = espacioLibreMapper.toDto(updatedEspacioLibre);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EspacioLibreDTO.class);
        EspacioLibreDTO espacioLibreDTO1 = new EspacioLibreDTO();
        espacioLibreDTO1.setId(1L);
        EspacioLibreDTO espacioLibreDTO2 = new EspacioLibreDTO();
        assertThat(espacioLibreDTO1).isNotEqualTo(espacioLibreDTO2);
        espacioLibreDTO2.setId(espacioLibreDTO1.getId());
        assertThat(espacioLibreDTO1).isEqualTo(espacioLibreDTO2);
        espacioLibreDTO2.setId(2L);
        assertThat(espacioLibreDTO1).isNotEqualTo(espacioLibreDTO2);
        espacioLibreDTO1.setId(null);
        assertThat(espacioLibreDTO1).isNotEqualTo(espacioLibreDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(espacioLibreMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(espacioLibreMapper.fromId(null)).isNull();
    }
}
