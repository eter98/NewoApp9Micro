...
public class EspaciosReservaResourceIT {
    ...
    @Autowired
    private EspaciosReservaMapper espaciosReservaMapper;
    ...
    public void createEspaciosReserva() throws Exception {
        ...
        EspaciosReservaDTO espaciosReservaDTO = espaciosReservaMapper.toDto(espaciosReserva);
        restEspaciosReservaMockMvc.perform(post("/api/espacios-reservas")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(espaciosReservaDTO)))
    ...
    public void updateEspaciosReserva() throws Exception {
        ...
        updatedEspaciosReserva
            ...
            .tarifa8Hora(UPDATED_TARIFA_8_HORA)
            .impuesto(UPDATED_IMPUESTO);
        EspaciosReservaDTO espaciosReservaDTO = espaciosReservaMapper.toDto(updatedEspaciosReserva);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(EspaciosReservaDTO.class);
        EspaciosReservaDTO espaciosReservaDTO1 = new EspaciosReservaDTO();
        espaciosReservaDTO1.setId(1L);
        EspaciosReservaDTO espaciosReservaDTO2 = new EspaciosReservaDTO();
        assertThat(espaciosReservaDTO1).isNotEqualTo(espaciosReservaDTO2);
        espaciosReservaDTO2.setId(espaciosReservaDTO1.getId());
        assertThat(espaciosReservaDTO1).isEqualTo(espaciosReservaDTO2);
        espaciosReservaDTO2.setId(2L);
        assertThat(espaciosReservaDTO1).isNotEqualTo(espaciosReservaDTO2);
        espaciosReservaDTO1.setId(null);
        assertThat(espaciosReservaDTO1).isNotEqualTo(espaciosReservaDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(espaciosReservaMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(espaciosReservaMapper.fromId(null)).isNull();
    }
}
