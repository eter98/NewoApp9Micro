...
public class SedesResourceIT {
    ...
    @Autowired
    private SedesMapper sedesMapper;
    ...
    public void createSedes() throws Exception {
        ...
        // Create the Sedes
        SedesDTO sedesDTO = sedesMapper.toDto(sedes);
        restSedesMockMvc.perform(post("/api/sedes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(sedesDTO)))
    ...
    public void updateSedes() throws Exception {
        ...
        updatedSedes
            ...
            .imagen6(UPDATED_IMAGEN_6)
            .imagen6ContentType(UPDATED_IMAGEN_6_CONTENT_TYPE);
        SedesDTO sedesDTO = sedesMapper.toDto(updatedSedes);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(SedesDTO.class);
        SedesDTO sedesDTO1 = new SedesDTO();
        sedesDTO1.setId(1L);
        SedesDTO sedesDTO2 = new SedesDTO();
        assertThat(sedesDTO1).isNotEqualTo(sedesDTO2);
        sedesDTO2.setId(sedesDTO1.getId());
        assertThat(sedesDTO1).isEqualTo(sedesDTO2);
        sedesDTO2.setId(2L);
        assertThat(sedesDTO1).isNotEqualTo(sedesDTO2);
        sedesDTO1.setId(null);
        assertThat(sedesDTO1).isNotEqualTo(sedesDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(sedesMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(sedesMapper.fromId(null)).isNull();
    }
}
