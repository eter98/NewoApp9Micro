...
public class BeneficioResourceIT {
    ...
    public void updateBeneficio() throws Exception {
        ...
        updatedBeneficio
            .tipoBeneficio(UPDATED_TIPO_BENEFICIO)
            .descuento(UPDATED_DESCUENTO);
        BeneficioDTO beneficioDTO = beneficioMapper.toDto(updatedBeneficio);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(BeneficioDTO.class);
        BeneficioDTO beneficioDTO1 = new BeneficioDTO();
        beneficioDTO1.setId(1L);
        BeneficioDTO beneficioDTO2 = new BeneficioDTO();
        assertThat(beneficioDTO1).isNotEqualTo(beneficioDTO2);
        beneficioDTO2.setId(beneficioDTO1.getId());
        assertThat(beneficioDTO1).isEqualTo(beneficioDTO2);
        beneficioDTO2.setId(2L);
        assertThat(beneficioDTO1).isNotEqualTo(beneficioDTO2);
        beneficioDTO1.setId(null);
        assertThat(beneficioDTO1).isNotEqualTo(beneficioDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(beneficioMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(beneficioMapper.fromId(null)).isNull();
    }
}
