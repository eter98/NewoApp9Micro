...
public class PrepagoConsumoResourceIT {
    ...
    @Autowired
    private PrepagoConsumoMapper prepagoConsumoMapper;
    ...
    public void createPrepagoConsumo() throws Exception {
        ...
        PrepagoConsumoDTO prepagoConsumoDTO = prepagoConsumoMapper.toDto(prepagoConsumo);
        restPrepagoConsumoMockMvc.perform(post("/api/prepago-consumos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(prepagoConsumoDTO)))
    ...
    public void updatePrepagoConsumo() throws Exception {
        ...
        updatedPrepagoConsumo
            ...
            .fechaRegistro(UPDATED_FECHA_REGISTRO)
            .fechaSaldoActual(UPDATED_FECHA_SALDO_ACTUAL);
        PrepagoConsumoDTO prepagoConsumoDTO = prepagoConsumoMapper.toDto(updatedPrepagoConsumo);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(PrepagoConsumoDTO.class);
        PrepagoConsumoDTO prepagoConsumoDTO1 = new PrepagoConsumoDTO();
        prepagoConsumoDTO1.setId(1L);
        PrepagoConsumoDTO prepagoConsumoDTO2 = new PrepagoConsumoDTO();
        assertThat(prepagoConsumoDTO1).isNotEqualTo(prepagoConsumoDTO2);
        prepagoConsumoDTO2.setId(prepagoConsumoDTO1.getId());
        assertThat(prepagoConsumoDTO1).isEqualTo(prepagoConsumoDTO2);
        prepagoConsumoDTO2.setId(2L);
        assertThat(prepagoConsumoDTO1).isNotEqualTo(prepagoConsumoDTO2);
        prepagoConsumoDTO1.setId(null);
        assertThat(prepagoConsumoDTO1).isNotEqualTo(prepagoConsumoDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(prepagoConsumoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(prepagoConsumoMapper.fromId(null)).isNull();
    }
}
