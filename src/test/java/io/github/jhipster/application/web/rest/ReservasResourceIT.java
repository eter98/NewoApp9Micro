...
public class ReservasResourceIT {
    ...
    public void createReservas() throws Exception {
        ...
        restReservasMockMvc.perform(post("/api/reservas")
            ...
            .content(TestUtil.convertObjectToJsonBytes(reservasDTO)))
    ...
    public void testEntityFromId() {
        assertThat(reservasMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(reservasMapper.fromId(null)).isNull();
    }
}
