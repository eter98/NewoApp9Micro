...
public class CuentaAsociadaResourceIT {
    ...
    @Autowired
    private CuentaAsociadaMapper cuentaAsociadaMapper;
    ...
    public void createCuentaAsociada() throws Exception {
        ...
        CuentaAsociadaDTO cuentaAsociadaDTO = cuentaAsociadaMapper.toDto(cuentaAsociada);
        restCuentaAsociadaMockMvc.perform(post("/api/cuenta-asociadas")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(cuentaAsociadaDTO)))
    ...
    public void updateCuentaAsociada() throws Exception {
        ...
        updatedCuentaAsociada
            ...
            .codigoSeguridad(UPDATED_CODIGO_SEGURIDAD)
            .fechaVencimiento(UPDATED_FECHA_VENCIMIENTO);
        CuentaAsociadaDTO cuentaAsociadaDTO = cuentaAsociadaMapper.toDto(updatedCuentaAsociada);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(CuentaAsociadaDTO.class);
        CuentaAsociadaDTO cuentaAsociadaDTO1 = new CuentaAsociadaDTO();
        cuentaAsociadaDTO1.setId(1L);
        CuentaAsociadaDTO cuentaAsociadaDTO2 = new CuentaAsociadaDTO();
        assertThat(cuentaAsociadaDTO1).isNotEqualTo(cuentaAsociadaDTO2);
        cuentaAsociadaDTO2.setId(cuentaAsociadaDTO1.getId());
        assertThat(cuentaAsociadaDTO1).isEqualTo(cuentaAsociadaDTO2);
        cuentaAsociadaDTO2.setId(2L);
        assertThat(cuentaAsociadaDTO1).isNotEqualTo(cuentaAsociadaDTO2);
        cuentaAsociadaDTO1.setId(null);
        assertThat(cuentaAsociadaDTO1).isNotEqualTo(cuentaAsociadaDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(cuentaAsociadaMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(cuentaAsociadaMapper.fromId(null)).isNull();
    }
}
