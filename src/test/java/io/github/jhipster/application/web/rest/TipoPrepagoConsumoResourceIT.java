...
public class TipoPrepagoConsumoResourceIT {
    ...
    @Autowired
    private TipoPrepagoConsumoMapper tipoPrepagoConsumoMapper;
    ...
    public void createTipoPrepagoConsumo() throws Exception {
        ...
        TipoPrepagoConsumoDTO tipoPrepagoConsumoDTO = tipoPrepagoConsumoMapper.toDto(tipoPrepagoConsumo);
        restTipoPrepagoConsumoMockMvc.perform(post("/api/tipo-prepago-consumos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(tipoPrepagoConsumoDTO)))
    ...
    public void updateTipoPrepagoConsumo() throws Exception {
        ...
        updatedTipoPrepagoConsumo
            ...
            .valorMinimo(UPDATED_VALOR_MINIMO)
            .valorMaximo(UPDATED_VALOR_MAXIMO);
        TipoPrepagoConsumoDTO tipoPrepagoConsumoDTO = tipoPrepagoConsumoMapper.toDto(updatedTipoPrepagoConsumo);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(TipoPrepagoConsumoDTO.class);
        TipoPrepagoConsumoDTO tipoPrepagoConsumoDTO1 = new TipoPrepagoConsumoDTO();
        tipoPrepagoConsumoDTO1.setId(1L);
        TipoPrepagoConsumoDTO tipoPrepagoConsumoDTO2 = new TipoPrepagoConsumoDTO();
        assertThat(tipoPrepagoConsumoDTO1).isNotEqualTo(tipoPrepagoConsumoDTO2);
        tipoPrepagoConsumoDTO2.setId(tipoPrepagoConsumoDTO1.getId());
        assertThat(tipoPrepagoConsumoDTO1).isEqualTo(tipoPrepagoConsumoDTO2);
        tipoPrepagoConsumoDTO2.setId(2L);
        assertThat(tipoPrepagoConsumoDTO1).isNotEqualTo(tipoPrepagoConsumoDTO2);
        tipoPrepagoConsumoDTO1.setId(null);
        assertThat(tipoPrepagoConsumoDTO1).isNotEqualTo(tipoPrepagoConsumoDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(tipoPrepagoConsumoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(tipoPrepagoConsumoMapper.fromId(null)).isNull();
    }
}
