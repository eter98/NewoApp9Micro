...
public class PerfilEquipoEmpresaResourceIT {
    ...
    @Autowired
    private PerfilEquipoEmpresaMapper perfilEquipoEmpresaMapper;
    ...
    public void createPerfilEquipoEmpresa() throws Exception {
        ...
        PerfilEquipoEmpresaDTO perfilEquipoEmpresaDTO = perfilEquipoEmpresaMapper.toDto(perfilEquipoEmpresa);
        restPerfilEquipoEmpresaMockMvc.perform(post("/api/perfil-equipo-empresas")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(perfilEquipoEmpresaDTO)))
    ...
    public void updatePerfilEquipoEmpresa() throws Exception {
        ...
        updatedPerfilEquipoEmpresa
            ...
            .idGoogle(UPDATED_ID_GOOGLE)
            .twiter(UPDATED_TWITER);
        PerfilEquipoEmpresaDTO perfilEquipoEmpresaDTO = perfilEquipoEmpresaMapper.toDto(updatedPerfilEquipoEmpresa);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(PerfilEquipoEmpresaDTO.class);
        PerfilEquipoEmpresaDTO perfilEquipoEmpresaDTO1 = new PerfilEquipoEmpresaDTO();
        perfilEquipoEmpresaDTO1.setId(1L);
        PerfilEquipoEmpresaDTO perfilEquipoEmpresaDTO2 = new PerfilEquipoEmpresaDTO();
        assertThat(perfilEquipoEmpresaDTO1).isNotEqualTo(perfilEquipoEmpresaDTO2);
        perfilEquipoEmpresaDTO2.setId(perfilEquipoEmpresaDTO1.getId());
        assertThat(perfilEquipoEmpresaDTO1).isEqualTo(perfilEquipoEmpresaDTO2);
        perfilEquipoEmpresaDTO2.setId(2L);
        assertThat(perfilEquipoEmpresaDTO1).isNotEqualTo(perfilEquipoEmpresaDTO2);
        perfilEquipoEmpresaDTO1.setId(null);
        assertThat(perfilEquipoEmpresaDTO1).isNotEqualTo(perfilEquipoEmpresaDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(perfilEquipoEmpresaMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(perfilEquipoEmpresaMapper.fromId(null)).isNull();
    }
}
