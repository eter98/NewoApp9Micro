...
public class TipoRecursoResourceIT {
    ...
    public void createTipoRecurso() throws Exception {
        ...
        restTipoRecursoMockMvc.perform(post("/api/tipo-recursos")
            ...
            .content(TestUtil.convertObjectToJsonBytes(tipoRecursoDTO)))
    ...
    public void testEntityFromId() {
        assertThat(tipoRecursoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(tipoRecursoMapper.fromId(null)).isNull();
    }
}
