...
public class MiembrosGrupoResourceIT {
    ...
    @Autowired
    private MiembrosGrupoMapper miembrosGrupoMapper;
    ...
    public void createMiembrosGrupo() throws Exception {
        ...
        MiembrosGrupoDTO miembrosGrupoDTO = miembrosGrupoMapper.toDto(miembrosGrupo);
        restMiembrosGrupoMockMvc.perform(post("/api/miembros-grupos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(miembrosGrupoDTO)))
    ...
    public void updateMiembrosGrupo() throws Exception {
        ...
        MiembrosGrupoDTO miembrosGrupoDTO = miembrosGrupoMapper.toDto(updatedMiembrosGrupo);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(MiembrosGrupoDTO.class);
        MiembrosGrupoDTO miembrosGrupoDTO1 = new MiembrosGrupoDTO();
        miembrosGrupoDTO1.setId(1L);
        MiembrosGrupoDTO miembrosGrupoDTO2 = new MiembrosGrupoDTO();
        assertThat(miembrosGrupoDTO1).isNotEqualTo(miembrosGrupoDTO2);
        miembrosGrupoDTO2.setId(miembrosGrupoDTO1.getId());
        assertThat(miembrosGrupoDTO1).isEqualTo(miembrosGrupoDTO2);
        miembrosGrupoDTO2.setId(2L);
        assertThat(miembrosGrupoDTO1).isNotEqualTo(miembrosGrupoDTO2);
        miembrosGrupoDTO1.setId(null);
        assertThat(miembrosGrupoDTO1).isNotEqualTo(miembrosGrupoDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(miembrosGrupoMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(miembrosGrupoMapper.fromId(null)).isNull();
    }
}
