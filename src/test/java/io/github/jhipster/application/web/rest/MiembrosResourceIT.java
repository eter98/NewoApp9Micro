...
public class MiembrosResourceIT {
    ...
    public void createMiembros() throws Exception {
        ...
        // Create the Miembros
        MiembrosDTO miembrosDTO = miembrosMapper.toDto(miembros);
        restMiembrosMockMvc.perform(post("/api/miembros")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(miembrosDTO)))
    ...
    public void updateMiembros() throws Exception {
        ...
        updatedMiembros
            ...
            .aliado(UPDATED_ALIADO)
            .host(UPDATED_HOST);
        MiembrosDTO miembrosDTO = miembrosMapper.toDto(updatedMiembros);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(MiembrosDTO.class);
        MiembrosDTO miembrosDTO1 = new MiembrosDTO();
        miembrosDTO1.setId(1L);
        MiembrosDTO miembrosDTO2 = new MiembrosDTO();
        assertThat(miembrosDTO1).isNotEqualTo(miembrosDTO2);
        miembrosDTO2.setId(miembrosDTO1.getId());
        assertThat(miembrosDTO1).isEqualTo(miembrosDTO2);
        miembrosDTO2.setId(2L);
        assertThat(miembrosDTO1).isNotEqualTo(miembrosDTO2);
        miembrosDTO1.setId(null);
        assertThat(miembrosDTO1).isNotEqualTo(miembrosDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(miembrosMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(miembrosMapper.fromId(null)).isNull();
    }
}
