...
public class GruposResourceIT {
    ...
    public void createGrupos() throws Exception {
        ...
        // Create the Grupos
        GruposDTO gruposDTO = gruposMapper.toDto(grupos);
        restGruposMockMvc.perform(post("/api/grupos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(gruposDTO)))
    ...
    public void updateGrupos() throws Exception {
        ...
        updatedGrupos
            ...
            .banner(UPDATED_BANNER)
            .bannerContentType(UPDATED_BANNER_CONTENT_TYPE);
        GruposDTO gruposDTO = gruposMapper.toDto(updatedGrupos);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(GruposDTO.class);
        GruposDTO gruposDTO1 = new GruposDTO();
        gruposDTO1.setId(1L);
        GruposDTO gruposDTO2 = new GruposDTO();
        assertThat(gruposDTO1).isNotEqualTo(gruposDTO2);
        gruposDTO2.setId(gruposDTO1.getId());
        assertThat(gruposDTO1).isEqualTo(gruposDTO2);
        gruposDTO2.setId(2L);
        assertThat(gruposDTO1).isNotEqualTo(gruposDTO2);
        gruposDTO1.setId(null);
        assertThat(gruposDTO1).isNotEqualTo(gruposDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(gruposMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(gruposMapper.fromId(null)).isNull();
    }
}
