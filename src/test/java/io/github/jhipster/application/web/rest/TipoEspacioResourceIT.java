...
public class TipoEspacioResourceIT {
    ...
    public void createTipoEspacio() throws Exception {
        ...
        restTipoEspacioMockMvc.perform(post("/api/tipo-espacios")
            ...
            .content(TestUtil.convertObjectToJsonBytes(tipoEspacioDTO)))
    ...
    public void updateTipoEspacio() throws Exception {
        ...
        updatedTipoEspacio
            .tipoEspacio(UPDATED_TIPO_ESPACIO);
        TipoEspacioDTO tipoEspacioDTO = tipoEspacioMapper.toDto(updatedTipoEspacio);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(TipoEspacioDTO.class);
        TipoEspacioDTO tipoEspacioDTO1 = new TipoEspacioDTO();
        tipoEspacioDTO1.setId(1L);
        TipoEspacioDTO tipoEspacioDTO2 = new TipoEspacioDTO();
        assertThat(tipoEspacioDTO1).isNotEqualTo(tipoEspacioDTO2);
        tipoEspacioDTO2.setId(tipoEspacioDTO1.getId());
        assertThat(tipoEspacioDTO1).isEqualTo(tipoEspacioDTO2);
        tipoEspacioDTO2.setId(2L);
        assertThat(tipoEspacioDTO1).isNotEqualTo(tipoEspacioDTO2);
        tipoEspacioDTO1.setId(null);
        assertThat(tipoEspacioDTO1).isNotEqualTo(tipoEspacioDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(tipoEspacioMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(tipoEspacioMapper.fromId(null)).isNull();
    }
}
