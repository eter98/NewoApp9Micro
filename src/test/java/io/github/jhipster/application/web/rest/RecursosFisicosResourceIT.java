...
public class RecursosFisicosResourceIT {
    ...
    @Autowired
    private RecursosFisicosMapper recursosFisicosMapper;
    ...
    public void createRecursosFisicos() throws Exception {
        ...
        RecursosFisicosDTO recursosFisicosDTO = recursosFisicosMapper.toDto(recursosFisicos);
        restRecursosFisicosMockMvc.perform(post("/api/recursos-fisicos")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(recursosFisicosDTO)))
    ...
    public void updateRecursosFisicos() throws Exception {
        ...
        updatedRecursosFisicos
            ...
            .video(UPDATED_VIDEO)
            .videoContentType(UPDATED_VIDEO_CONTENT_TYPE);
        RecursosFisicosDTO recursosFisicosDTO = recursosFisicosMapper.toDto(updatedRecursosFisicos);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(RecursosFisicosDTO.class);
        RecursosFisicosDTO recursosFisicosDTO1 = new RecursosFisicosDTO();
        recursosFisicosDTO1.setId(1L);
        RecursosFisicosDTO recursosFisicosDTO2 = new RecursosFisicosDTO();
        assertThat(recursosFisicosDTO1).isNotEqualTo(recursosFisicosDTO2);
        recursosFisicosDTO2.setId(recursosFisicosDTO1.getId());
        assertThat(recursosFisicosDTO1).isEqualTo(recursosFisicosDTO2);
        recursosFisicosDTO2.setId(2L);
        assertThat(recursosFisicosDTO1).isNotEqualTo(recursosFisicosDTO2);
        recursosFisicosDTO1.setId(null);
        assertThat(recursosFisicosDTO1).isNotEqualTo(recursosFisicosDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(recursosFisicosMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(recursosFisicosMapper.fromId(null)).isNull();
    }
}
