...
public class ProductosServiciosResourceIT {
    ...
    @Autowired
    private ProductosServiciosMapper productosServiciosMapper;
    ...
    public void createProductosServicios() throws Exception {
        ...
        ProductosServiciosDTO productosServiciosDTO = productosServiciosMapper.toDto(productosServicios);
        restProductosServiciosMockMvc.perform(post("/api/productos-servicios")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(productosServiciosDTO)))
    ...
    public void updateProductosServicios() throws Exception {
        ...
        updatedProductosServicios
            ...
            .imagen6(UPDATED_IMAGEN_6)
            .imagen6ContentType(UPDATED_IMAGEN_6_CONTENT_TYPE);
        ProductosServiciosDTO productosServiciosDTO = productosServiciosMapper.toDto(updatedProductosServicios);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(ProductosServiciosDTO.class);
        ProductosServiciosDTO productosServiciosDTO1 = new ProductosServiciosDTO();
        productosServiciosDTO1.setId(1L);
        ProductosServiciosDTO productosServiciosDTO2 = new ProductosServiciosDTO();
        assertThat(productosServiciosDTO1).isNotEqualTo(productosServiciosDTO2);
        productosServiciosDTO2.setId(productosServiciosDTO1.getId());
        assertThat(productosServiciosDTO1).isEqualTo(productosServiciosDTO2);
        productosServiciosDTO2.setId(2L);
        assertThat(productosServiciosDTO1).isNotEqualTo(productosServiciosDTO2);
        productosServiciosDTO1.setId(null);
        assertThat(productosServiciosDTO1).isNotEqualTo(productosServiciosDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(productosServiciosMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(productosServiciosMapper.fromId(null)).isNull();
    }
}
