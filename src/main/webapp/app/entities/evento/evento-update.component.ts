...
export class EventoUpdateComponent implements OnInit {
  ...
  updateForm(evento: IEvento) {
    this.editForm.patchValue({
      ...
      gruposId: evento.gruposId,
      miembroId: evento.miembroId
    });
  }
  ...
  private createFromForm(): IEvento {
    return {
      ...
      categoriaEventoId: this.editForm.get(['categoriaEventoId']).value,
      gruposId: this.editForm.get(['gruposId']).value,
